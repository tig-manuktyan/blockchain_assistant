...
export class OpenAiService {
  ...
  constructor(
    ...
    this.openAICommandTemplate = `я тебе отправлю текст <<>> на внутри скобках, ты мне догадайся если я тебе отправлю смс о криптавалют или проста имя токена , мне возвращай объект,и чтобы не отправил язык на котором написано { 
type: "crypto",
symbol: имя или symbol токена и пиши имя криптовалютах на английском,
lang: ru || en 
}
